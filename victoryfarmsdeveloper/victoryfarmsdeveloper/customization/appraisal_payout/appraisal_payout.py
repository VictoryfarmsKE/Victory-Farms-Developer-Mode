...
class CustomAppraisalPayout(Document):
	...
	def calculate_scores_and_payout(self):
		...
		for entry in self.appraisal_payout_details:
			...
			individual_matrix_percent = self.get_matrix_percent(entry.individual_score)
			individual_bonus_percent = self.get_bonus_percent(entry.bonus_potential, individual_matrix_percent)
			...
			department_matrix_percent = self.get_matrix_percent(entry.department_score)
			department_bonus_percent = self.get_bonus_percent(entry.bonus_potential_department, department_matrix_percent)
