    ...
    def set_employees(self):
        ...
        if employees:
            ...
            for data in employees:
                if not appraisal_templates.get(data.custom_appraisal_template):
                ...
                self.append(
                    "appraisees",
                    {
                        ...
                        "appraisal_template": data.custom_appraisal_template,
                    },
                )
...
def create_appraisals_for_cycle(appraisal_cycle: CustomAppraisalCycle, publish_progress: bool = False):
    """
