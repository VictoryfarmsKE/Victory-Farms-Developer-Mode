...
def get_earning_and_deduction_types(salary_slips):
	...
	for salary_component in get_salary_components(salary_slips):
		...
		preferred_earning_order = ["Basic Pay", "Basic Salary", "OT hours", "Holiday Hours", "Arrear", "Bonus Department", "Bonus Department (Quarterly)", "Bonus Department (Annual)", "Bonus Individual", "Bonus Individual (Quarterly)", "Bonus Individual (Annual)", "Bonus Company (Annual)", "Commercial Commission", "Commercial Holiday Pay", "Education Allowance", "General Allowance", "Urban Allowance", "House Rent", "Leave Encashment", "Net Arrears", "Notice Allowance", "OP Arrears", "Taxable Income", "Transport Allowance", "Unpaid Leave", "Salary Advance"]
