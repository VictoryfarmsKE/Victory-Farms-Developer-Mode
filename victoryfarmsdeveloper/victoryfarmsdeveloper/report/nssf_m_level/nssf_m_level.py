...
def execute(filters=None):
    ...
    sql = f"""
        SELECT
            ...
            ss.gross_pay,
            (SELECT sd.amount FROM `tabSalary Detail` sd WHERE sd.parent = ss.name AND sd.salary_component = 'Gross Pay' LIMIT 1) AS gross,
        ...
        WHERE {conditions} AND (ss.custom_grade LIKE 'M%%' OR ss.custom_grade LIKE 'AM%%')
    ...
    columns = [
        ...
        {"label": "Gross Pay", "fieldname": "gross", "fieldtype": "Currency", "width": 120},
